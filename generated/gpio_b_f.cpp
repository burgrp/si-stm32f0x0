namespace target {
  ...
  extern volatile gpio_b_f::Peripheral GPIOF;
  extern volatile gpio_b_f::Peripheral GPIOD;
  extern volatile gpio_b_f::Peripheral GPIOC;
  extern volatile gpio_b_f::Peripheral GPIOB;
}